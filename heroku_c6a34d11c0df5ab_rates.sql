...
CREATE TABLE `rates` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKrf7d1thujg4oun4uk8fk41yne` (`drink_id`),
  KEY `FKanlgavwqngljux10mtly8qr6f` (`user_id`),
  CONSTRAINT `FKanlgavwqngljux10mtly8qr6f` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FKrf7d1thujg4oun4uk8fk41yne` FOREIGN KEY (`drink_id`) REFERENCES `drinks` (`id`)
...
INSERT INTO `rates` VALUES (1,100,100,901);
