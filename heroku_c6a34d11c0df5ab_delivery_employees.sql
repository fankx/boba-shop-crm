...
CREATE TABLE `delivery_employees` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FKij01sv7b624xcg360idhdlemh` FOREIGN KEY (`id`) REFERENCES `employees` (`id`)
...
INSERT INTO `delivery_employees` VALUES (300),(301);
...
-- Dump completed on 2021-12-12 19:18:25
